...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <form class="p-4 flex space-x-4 justify-center items-center" action="/" method="post">
            ...
            <textarea id="message" name="message" id="" class="border rounded-md  p-2 flex-1"></textarea>
            <input type="submit" class="cursor-pointer bg-gray-800 text-white p-2 rounded-md" value="Send">
